  ...
  return (
    <footer className='border '>
        <div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row lg:justify-between lg:items-center">
            ...
            <div className="flex flex-row justify-center pt-6 lg:pt-0">
                ...
                <div className="flex justify-center space-x-4">
                   <a rel="noopener noreferrer" href="https://www.github.com/Bartlomiej28" title="GitHub" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10">
